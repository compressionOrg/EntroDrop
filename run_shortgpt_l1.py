...
def block_influence(
    ...
    if metric == "normalized_combo":
        ...
        return l1_norm + cos_sim_term_norm
...
if __name__ == "__main__":
    ...
    model.save_pretrained(f'{model_name}_shortgpt_l1_layers{num_prune_layers}')
    tokenizer.save_pretrained(f'{model_name}_shortgpt_l1_layers{num_prune_layers}')
