...
if __name__ == "__main__":
    model_name = '../short_gpt/models/Pruned_Models/Pruned_llama2_dataset_sec-data-mini_layers_7/'
    # 在模型加载时添加量化
    ...
    result = evaluate_model(peft_model, tokenizer, model_name=model_name, tasks="mathqa,piqa,hellaswag,winogrande,arc_easy,arc_challenge,openbookqa,boolq", eval_ppl="wikitext2,ptb", device=device, is_peft_model=True) # boolq,piqa,hellaswag,winogrande,arc_easy,arc_challenge,openbookqa
